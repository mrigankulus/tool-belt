...
// todo: hopefully this can go away at some point. The emoji filter didn't expose it's emojis
// and we need to be able to search them.

appModule.factory('emojiList', function () {
    return {
        ...
        "two_men_holding_hands": ["couple", "love", "like", "bromance", "friendship", "people", "human"],
        "two_women_holding_hands": ["friendship", "couple", "love", "like", "female", "people", "human"],
